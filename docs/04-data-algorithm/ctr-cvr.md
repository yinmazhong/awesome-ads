...
2010        2012        2014        2016        2018        2020        2023+
 │           │           │           │           │           │           │
 ▼           ▼           ▼           ▼           ▼           ▼           ▼
 LR      GBDT+LR     FM/FFM     Wide&Deep   DIN/DIEN    多任务模型   大模型
                                  DeepFM                  MMOE/PLE   增强
...
Wide: 记忆 (Memorization) — 记住历史出现过的特征组合
Deep: 泛化 (Generalization) — 学习未见过的特征组合
```
